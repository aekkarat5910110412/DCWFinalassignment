...
function App() {
  ...
  const getEmployees = () => {
    Axios.get("http://localhost:3333/employees").then((response) => {
  ...
  const updateEmployeeWage = (id) => {
    Axios.put("http://localhost:3333/update", { wage: newWage, id: id }).then(
      (response) => {
        setEmployeeList(
  ...
  const deleteEmployee = (id) => {
    Axios.delete(`http://localhost:3333/delete/${id}`).then((response) => {
      setEmployeeList(
